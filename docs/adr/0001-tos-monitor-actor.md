...
Pearson plc, per ADR-2607110300 -- a read-only reference archive. As part of
...
- **Company**: Pearson plc, LEI 2138004JBXWWJKIURC57, website
...
- **Baseline provenance** (real, from this repo's own `80-data/public/
  ...
  retrieved-at `2026-07-10T11:02:24Z`, doc-type `:terms-of-service`.
