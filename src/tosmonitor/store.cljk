(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Pearson plc, LEI
  2138004JBXWWJKIURC57) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "Pearson plc"
   :website    "https://www.pearson.com"})

(def ^:private demo-full-text
  "Terms of Use\nBy using this website you agree to these Terms of Use. This site is operated by Pearson plc, a global education and publishing company, and its content is provided for informational purposes only and may change without notice. These Terms are governed by, and construed in accordance with, the laws of England and Wales.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.pearson.com/legal-information/terms-of-use.html"
   :retrieved-at "2026-07-10T11:02:24Z"
